...
* 本次实验的收获
  ...
  * 通过本次实验我了解更多的如Verilog关键字，代码结构，数据类型以及运算符。
  * 能够流畅阅读Verilog代码并分析其作用
  * 能够将Verilog中的代码与实际电路相对应，知道代码会综合形成的电路

* 本次实验的难易程度

  * 有关Verilog语法的内容较多，但本次练习题相对单一总体较为简单。
