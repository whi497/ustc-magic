...
set_property -dict { PACKAGE_PIN A14   IOSTANDARD LVCMOS33 } [get_ports { outdisplay[0] }];
set_property -dict { PACKAGE_PIN A13   IOSTANDARD LVCMOS33 } [get_ports { outdisplay[1] }];
set_property -dict { PACKAGE_PIN A16   IOSTANDARD LVCMOS33 } [get_ports { outdisplay[2] }];
set_property -dict { PACKAGE_PIN A15   IOSTANDARD LVCMOS33 } [get_ports { outdisplay[3] }];
